...
export default function Editar() {
    ...
    function getMusica() {
        axios.get(`http://localhost/backend/musica/${id}`).then(function(response) {
    ...
    const handleSubmit = (event) => {
        ...
        axios.put(`http://localhost/backend/musica/${id}/editar`, inputs).then(function(response){
            console.log(response.data);
            navigate('/musica');
        });
        ...
        <div className="moverCrear">
            <div className="border-dark grid gap-3">
                <form onSubmit={handleSubmit}>
                    <h3 className="text-center text-Dark">Editar la Musica</h3>
                    <div className="mb-3">
